...
public class SisMedico extends JFrame implements ActionListener {
    ...
    public void Botoes(){
        ...
        // Botao Confirma
        //ImageIcon Im1 = new ImageIcon("c:/Java/JavaImagens/Saida_1.gif");
    ...
    public static void main (String[] args) {      
        ...
        SisMedico viewSec = new SisMedico();
